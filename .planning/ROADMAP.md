...
- [ ] **Phase 1: Rendering Pipeline and Primitives** - Static scenes with styled shapes rendered to MP4 video
...
|-------|----------------|--------|-----------|
| 1. Rendering Pipeline and Primitives | 0/5 | Planning complete | - |
| 2. Animation Engine | 0/0 | Not started | - |
